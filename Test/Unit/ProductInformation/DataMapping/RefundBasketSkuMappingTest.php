...
use Axytos\KaufAufRechnung\DataMapping\RefundBasketPositionDtoCollectionFactory;
...
class RefundBasketSkuMappingTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->sut = new RefundBasketDtoFactory(
            new RefundBasketPositionDtoCollectionFactory(
                new RefundBasketPositionDtoFactory(),
                $productVariantResolver
            ),
            new RefundBasketTaxGroupDtoCollectionFactory(
                new RefundBasketTaxGroupDtoFactory(
    ...
    public function test_sku_mapping_for_not_configurable_items()
    {
        ...
        $basket = $this->sut->create($creditmemo);

        /** @var RefundBasketPositionDtoCollection */
